...
OBJS = main.o Logger.o System.o Window.o Surface.o Font.o ControlsManager.o Control.o PartModel.o PartView.o Event.o Scrollbar.o
TARGETS = main

all: $(TARGETS)

main: main.o Logger.o System.o Window.o Surface.o Font.o ControlsManager.o Control.o PartModel.o PartView.o Event.o Scrollbar.o
	$(CC) $^ $(LDLIBS) -o $@
