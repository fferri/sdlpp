...
OBJS = main.o Logger.o Application.o Timer.o Window.o Surface.o Font.o Control.o PartModel.o PartView.o Event.o Scrollbar.o Viewport.o DummyControl.o Button.o
TARGETS = main

all: $(TARGETS)

main: main.o Logger.o Application.o Timer.o Window.o Surface.o Font.o Control.o PartModel.o PartView.o Event.o Scrollbar.o Viewport.o DummyControl.o Button.o
	$(CC) $^ $(LDLIBS) -o $@
